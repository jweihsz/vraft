 ...
 **/
@Data
public class MqttPubRelMessage extends MqttBaseMessage {
    private MqttMessageIdVariableHeader variableHeader;
    private transient Handle<MqttPubRelMessage> handle;

    public MqttPubRelMessage(Handle<MqttPubRelMessage> handle) {
        this.handle = handle;
