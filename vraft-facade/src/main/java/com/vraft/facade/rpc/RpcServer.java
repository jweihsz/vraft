...
public interface RpcServer extends LifeCycle {
    boolean oneWay(long userId, long msgId, byte biz, long groupId,
        long nodeId, String uid, byte[] header,
        byte[] body) throws Exception;

    boolean twoWay(long userId, byte biz, long groupId, long nodeId,
        String uid, byte[] header, byte[] body, long timeout,
        CallBack cb) throws Exception;

    boolean resp(long userId, byte biz, long groupId, long nodeId,
